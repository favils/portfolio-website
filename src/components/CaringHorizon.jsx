    ...
    return (
        <div className="h-full bg-white overflow-hidden relative">
            <Image
                ...
                height={0}
                sizes="100vw"
                className="w-full h-full object-cover transition-transform duration-300 ease-in-out transform hover:scale-110 hover:rotate-1"
            />

            <Link href="https://github.com/favils?tab=repositories" target="_blank" rel="noopener noreferrer">
            ...
            <Link href="https://caring-horizon.vercel.app/" target="_blank" rel="noopener noreferrer">
